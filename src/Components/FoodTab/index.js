...
//                         }>
//                             {/* this div for txt clr ---- randering it for the prticulr condition - becomr a red if it matching to the items it otherwise blk clr  */}

//                             <div className={
//                                 type === items.id && "absolute -top-3 w-full h-2 border-zomato-500"/*no clss thn no ternary operation n there is && op.  */

//                             }>{items.icon}
//                                 {/* /*2nd this div for top-border clr */}
